...
echo "**************************************************************************************
    * Щоб запустити сервіс перейдить в папку проекта (SpringWSrest) та наберить: sudo bash springws-service.sh install
    * Щоб заповнити базу даних початковим набором наберить: python3 fill_fakerdb.py 100
    ****************************************************************************************"
