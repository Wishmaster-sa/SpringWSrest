...
Запуск вебсервісу здійснюється за допомогою скрипта `springws-service.sh`. Викоритсання скрипта описана в [настановах з адміністрування вебсервісу](/blob/main//README.md#Адміністрування-сервісу) 
