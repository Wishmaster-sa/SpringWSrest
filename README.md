...
- Інструкція з розгортання середовища Apache NetBeans
- Архітектура тестового приклада
...
3. Запустіть скрипт з каталогу SpringWSrest:
...
Якщо ви бажаєте видалити сервіс з переліку системних служб, то виконайте команду
   ```bash
   sudo bash springws-service.sh remove
   ```
